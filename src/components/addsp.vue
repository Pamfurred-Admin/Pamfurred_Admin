      ...
      <form @submit.prevent="handleSubmit">
        <div class="mb-4">
          ...
          <input
            ...
            class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-0 focus:ring-blue-500"
          />
        </div>
        ...
        <div class="mb-4">
          <label class="block text-gray-700 text-sm font-bold mb-2 text-left" for="closingTime">
            Closing Time
          </label>
          <input
